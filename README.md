...
- **Planning, data flow design and Brainstorming (Miro):**  
 ...
 ![Miro Brainstorming](Images/Miro_Brainstorming.png)
...
- **Task management & backlog tracking (JIRA & Confluence):**  
  ...
  Note: These platforms are no longer active for this project, so direct links cannot be shared. Screenshots are provided below to illustrate the workflow.
---
